...
<div class="block">
  <div class="name">Ivan:</div>
    It's going to be really tough to live up to that glowing introduction that Steve gave me, but I will do my best. My name is [Ivan Reese](http://spiralganglion.com) and I'm really excited to be on the podcast interviewing [Jack Rusher](http://jackrusher.com). Before we get to the interview, I will give you a whistle-stop tour of my programming career just so you know what sort of perspective I'll be bringing to the interview.
</div>

<div class="block">
  <div class="name">Ivan:</div>
    When I was about five years old, I started making silly interactive animations and games in [HyperCard](http://www.bbc.com/future/story/20190722-the-apple-software-that-inspired-the-internet) to annoy my sister, and I've been making silly interactive animations and games ever since.
</div>

<div class="block">
  <div class="name">Ivan:</div>
    I work for [a little education media company](https://www.lunchboxsessions.com). I was hired originally as a 3D animator there, though my role quickly expanded to include programming. I now make all of the frameworks and tools for the other artist-programmers in the company. My current project is [a visual programming language](https://twitter.com/spiralganglion/status/1145028588715950080) for building interactive animations. If you follow me on [Twitter](http://twitter.com/spiralganglion), you know that I tweet _insufferably_ about it.
</div>

<div class="block">
  <div class="name">Ivan:</div>
    Outside of programming, my main hobby is music. A curious tidbit: I have a collection of over 100 different instruments all of which I [play very badly](https://spiralganglion.bandcamp.com). Having a hobby as a musician and being a programmer means that I've had a lot of fun exploring the intersection of those two things. [Max/MSP](https://cycling74.com) was probably my introduction to visual programming and I still have a very soft spot in my heart for it.
</div>

<div class="block">
  <div class="name">Ivan:</div>
    So enough about me. Let me introduce [Jack Rusher](http://twitter.com/jackrusher), our guest on the show today. Jack is a programmer living in Berlin that I know via the Clojure community, though his interests in Lisp go way beyond that.
</div>

<div class="block">
  <div class="name">Ivan:</div>
    Jack has a fascinating history of projects that we talk about. Then we head fearlessly off into the weeds talking about logic programming, model checking, towers of abstractions, the history and future of visual programming languages, the aesthetics of programming tools, the principles of visual design that underlie all of our programming tools (whether we realize it or not), his consultancy in Berlin called [Applied Science](http://www.appliedscience.studio), and the programming environment that they built — a literate editor for teaching Clojure to new programmers called [Maria](https://www.maria.cloud).
</div>

<div class="block">
  <div class="name">Ivan:</div>
    Just before we get into the interview, I have a message to bring you from our sponsor, [Repl.it](https://repl.it). They sponsor the transcript of the show which you can find at [https://futureofcoding.org/episode/041](https://futureofcoding.org/episodes/041).
</div>
...
<div class="block">
  <div class="name">Jack:</div>
    Yeah. This is the first time that I had dealt with that particular situation in that way. But a few years later, around 2005 or 2006, I did a startup where we built a thing that kicked off the discipline called [complex event processing](https://en.wikipedia.org/wiki/Complex_event_processing) — or rather, the commercial phase of the discipline called complex event processing, which was the same sort of idea but applied to various industrial sectors. We were a company called Aleri, which is eventually purchased by Sybase, and the product is still sold by SAP today.
</div>
...
<div class="block">
  <div class="name">Jack:</div>
    Oh, [complex event processing](https://en.wikipedia.org/wiki/Complex_event_processing)! It's a terrible name. We did not coin the name. It comes from the research community and it just makes it all so much scarier than it is.
</div>
...
<div class="block">
  <div class="name">Ivan:</div>
    I think the first place we ran into each other was on the [ClojureVerse Forum](https://clojureverse.org). That was in a thread about the [Luna language/environment](https://www.luna-lang.org) that had just been announced where they're creating a very Haskell-like pure functional language and also creating a very nice sort of node-and-line based visual programming environment. They're two representations of the same underlying model.
</div>

<div class="block">
  <div class="name">Ivan:</div>
    We were looking at that environment and talking about the various merits, and projects that had tried this in the past, and some people started saying, "Hey, we should collect all of these projects [into one place](https://github.com/ivanreese/visual-programming-codex)."
</div>

<div class="block">
  <div class="name">Ivan:</div>
    You suggested that somebody pull on the model of [Shaun Lebron](https://twitter.com/shaunlebron)'s [History of Lisp Parens](https://github.com/shaunlebron/history-of-lisp-parens), which is this wonderful GitHub repo he made reviewing some of those beautiful environments that have been made for Lisp throughout history, and looking at not just the design of them and the choices that they've made but how they sort of—
</div>
...
<div class="block">
  <div class="name">Ivan:</div>
    Have you ever seen an environment that — because I'm used to seeing tools like TLA+ or Alloy as sort of separate from the actual language where the development work is being done — have you ever seen an environment that pulled those things together? Other than maybe [QuickCheck](https://en.wikipedia.org/wiki/QuickCheck), or something like that.
</div>
...
<div class="block">
  <div class="name">Ivan:</div>
    Is there a relationship between the sort of model checking that you've done and something that you might do with [miniKanren](http://minikanren.org)?
</div>
...
<div class="block">
  <div class="name">Ivan:</div>
    I'm sort of wondering aloud if there might be some kind of potential direction there for future tools to go, where they have the facilities of logic programming — like a Prolog or [Datalog](https://en.wikipedia.org/wiki/Datalog), miniKanren, or some sort of constraint solver — that you could use at the level of your domain problem if you need to, or you could also use it at a macro level, or... Is it [Black Scheme](https://www.youtube.com/watch?v=SrKj4hYic5A) where you have a tower of interpreters that you build? Is that the one?
</div>
...
<div class="block">
  <div class="name">Ivan:</div>
    Yeah. If there's something like that. Or like a [dependent typed](https://en.wikipedia.org/wiki/Dependent_type) kind of environment, where the same tools that you can use at one level you can use at another level up. I don't know that I've ever seen anything like that.
</div>

<div class="block">
  <div class="name">Jack:</div>
    I don't think... made quite so uniform, so it feels like one experience. But there are many situations where you find logic programming embedded in another programming language. That is typically how I personally prefer to use logic programming. So rather than turning to Prolog, for example, I would prefer to use miniKanren from Scheme, or, you know — [Oleg](https://dl.acm.org/author_page.cfm?id=81100177557) has some very nice work on embedded logic programming within ML dialects, especially OCaml and so on — because I find that's actually a much nicer way to program.
</div>
...
<div class="block">
  <div class="name">Jack:</div>
    For example, a good, fast Scheme implementation like [Chez Scheme](https://cisco.github.io/ChezScheme/) with something like miniKanren to work more towards the declarative side and the ability to actually allocate a bunch of bytes and set them in a tight loop — can get the work done.
</div>
...
<div class="block">
  <div class="name">Jack:</div>
    For me, I would want something that I could express well in a visual environment that translates across all of these domains. If I were building such a thing myself, I would maybe build it on top of Chez Scheme, but build an interface that looks something like [Scheme Bricks](http://www.pawfal.org/dave/index.cgi?Projects/Scheme%20Bricks) or Scheme blocks, which I think is actually a kind of nice, aesthetically pleasing variation on, say, the scratch idea of blocky things plugged together kind of programming, but again with a very uniform syntax that makes it visually quite easy to see what's happening at all the different layers.
</div>
...
<div class="block">
  <div class="name">Ivan:</div>
    My personal inclination is to always go for something that is in the direction of the nodes-and-lines, [Pure Data](https://en.wikipedia.org/wiki/Pure_Data), Smalltalk (to a certain extent) school of visual languages. Just because at that point you are in free space. You are in force-directed graph space — spit! You are in the space of having an open canvas in which to move things.
</div>
...
<div class="block">
  <div class="name">Ivan:</div>
    Yeah. The idea that you are tapping into these very powerful primitives at first, and so that offers a lot of leverage to people who are artists or musicians and not programmers — I think that's the whole reason why Max/MSP and Pure Data and [vvvv](https://vvvv.org) and all of them are as successful as they are.
</div>
...
<div class="block">
  <div class="name">Ivan:</div>
    That's [Matt Hubert](https://matt.is)?
</div>

<div class="block">
  <div class="name">Jack:</div>
    Matt Hubert, yeah — [available at a Twitter near you](https://twitter.com/mhuebert) — he started talking with me about this because he was very interested in trying to do something that had the power and approachability of a spreadsheet, but where the actual programming was done with a language he liked to use.
</div>
...
<div class="block">
  <div class="name">Jack:</div>
    You've really hit upon the feeling there as well. When Matt wrote a paper about cells that he presented in, I think, 2016 at a conference in Rome, the opening paragraph was something to the effect of [When I Sit Down At My Editor, I Feel Relaxed](http://px16.matt.is). For him, this is the emotional space that he wishes to inhabit when he's doing work — one of serenity. That helps to direct the user interface of Maria, definitely.
</div>
...
<div class="block">
  <div class="name">Ivan:</div>
    Yeah. The other person who you are working with is [Dave Liepmann](https://www.daveliepmann.com)
</div>
...
<div class="block">
  <div class="name">Jack:</div>
    Yeah. The URL is [appliedscience.studio](http://www.appliedscience.studio). There's the grotesque plug.
</div>
...
<div class="block">
  <div class="name">Jack:</div>
    If I'm plugging things, I always have to plug [Sam Aaron](http://sam.aaron.name) who is doing fantastic work with [Sonic Pi](https://sonic-pi.net). He's a good friend of mine and he's doing amazing work and everybody should support him — monetarily — as soon as possible. Go to [his Patreon](https://www.patreon.com/samaaron) and give him money because Sam is doing God's work.
</div>

<div class="block">
  <div class="name">Ivan:</div>
    Yup. Do you know, is he still working on [Overtone](http://overtone.github.io) at all or is that on hold just for the sake of Sonic Pi?
</div>
...
<div class="block">
  <div class="name">Ivan:</div>
    Yeah. You shared two papers with me. One of them is a [A visual perception account of programming languages: finding the natural science in the art](https://hal.inria.fr/hal-00737414). Then the other one, [Unifying Textual and Visual: A Theoretical Account of the Visual Perception of Programming Languages](https://dl.acm.org/citation.cfm?id=2661138).
</div>
...
<div class="block">
  <div class="name">Jack:</div>
    This mention of obscure things that you learn to associate with other things in order to make art has reminded me of something that I probably would have wanted to plug before, but I definitely think you should look at, which is an audio environment for a live coding music called... I think he pronounces it [Orca](https://github.com/Hundredrabbits/Orca), although he does this design thing that I hate which is that the "A" in Orca is actually a lambda, and so I want to say it as "Orcl". The GitHub username is [Hundredrabbits](https://github.com/Hundredrabbits).
</div>
...
<div class="block">
  <div class="name">Ivan:</div>
    Hundredrabbits, which is... I can't remember his last name, but.. [Lu... Linvega](https://twitter.com/Neauoire), something like that.
</div>
...
<div class="block">
  <div class="name">Ivan:</div>
    Yeah. Him, and his partner [[Rekka](https://twitter.com/RekkaBell)], I believe at one point they were living out of a boat.
</div>

<div class="block">
  <div class="name">Jack:</div>
    [They're living in a sailboat.](https://www.patreon.com/100)
</div>
...
<div class="block">
  <div class="name">Jack:</div>
    One thing we have been experimenting with in the context of [Maria.cloud](https://www.maria.cloud) is the idea of language levels, where a new arrival to the environment might be in a simpler language level that has more informative error messages and even factors away certain extremely error-prone parts of the language.
</div>
...
<div class="block">
  <div class="name">Ivan:</div>
    I listened to some of the stuff that you've [posted on SoundCloud](https://soundcloud.com/jackrusher). Do you have albums that you've put together?
</div>
...
<div class="block">
  <div class="name">Jack:</div>
    Yeah, all that stuff has just gone, gone, gone. But I am currently — because I'm in Berlin and it's _required_ actually as part of the terms of my residence, that I create some electronic music — I've bought a [Push 2](https://www.ableton.com/en/push/) and a couple copy of [Ableton Live](https://www.ableton.com/en/live/). I'm currently learning how to use that which, given that my musical training — actually, I minored in classical composition when I was at school, so it was all string quartets and things and I played in the jazz orchestra and so on — it's very analog, my music history. Now, I'm trying to make friends with these tools, and I'm absolute beginner again and I'm having a wonderful time. Probably, there will be an album of new songs sometime late this year, early next year.
</div>
...
<div class="block">
  <div class="name">Ivan:</div>
    One of them — [Karsten Schmidt, @toxi on Twitter](https://twitter.com/toxi) — he is a very, very cool programmer who works on this project called [thi.ng](http://thi.ng), and he has a TypeScript project called [@thi.ng/umbrella](https://github.com/thi-ng/umbrella/), and the original thi.ng project in Clojure is similar. They're these very, very cool, just monorepos full of resources for building computational geometry and interactive visualizations — just all sorts of wild ideas. Reading his code is like an education in itself. Jack says that Karsten has a [series of blog posts](https://medium.com/@thi.ng/of-umbrellas-transducers-reactive-streams-mushrooms-pt-1-a8717ce3a170) discussing his take on Clojure's reducers as implemented in TypeScript that he recommends to our community.
</div>

<div class="block">
  <div class="name">Ivan:</div>
    The one other link that he wanted to sneak in under the wire is [Nextjournal](https://nextjournal.com), which is Nextjournal.com. They are doing work on a multilingual online scientific notebook environment, so do go check that out as well. Now, back to your regularly scheduled programming.
</div>
...
<div class="block">
  <div class="name">Jack:</div>
    Well, I'm Jack Rusher — that is my actual name, and my username on pretty much every service you might care to find me on is my first name and my last name concatenated with no hyphen or space between. You can [find me on Twitter](https://twitter.com/jackrusher). If you like pictures of beautiful nature and my digital art pieces, you can [find me on Instagram](https://instagram.com/jackrusher). I have a website, [jackrusher.com](http://jackrusher.com).
</div>
...
<div class="block">
  <div class="name">Ivan:</div>
    That brings us to the end of the show. I hope you enjoyed it. You can find a whole bunch of other episodes of the podcast at [futureofcoding.org](https://futureofcoding.org/#episodes). There are also links to the [Slack group](https://futureofcoding.org/slack) where a bunch of us in the programming tools and programming languages community get together, and talk about our projects, and talk about our big dreams for what the future of computing might look like.
</div>

<div class="block">
  <div class="name">Ivan:</div>
    If you really like the podcast and you want to support it: leave a review. [Go to iTunes](https://podcasts.apple.com/podcast/future-of-coding/id1265527976) and just say what you think, that really helps people discover the show; tweet about it; you know the deal. Another way you can support the show and the community is to back [Steve on Patreon](https://www.patreon.com/stevekrouse). He does a ton of legwork to organize meet-ups, to promote people in the community to his audience, and to help everyone learn from everyone else. It's a tremendous service and anything you can do to help out Steve helps out all of us.
</div>

<div class="block">
  <div class="name">Ivan:</div>
    If you want to get in touch with me, I am on Twitter — [@spiralganglion](https://twitter.com/spiralganglion) (which is the nerve that connects the ear to the brain). You can of course find the show at [futureofcoding.org](https://futureofcoding.org). Thanks to Jack Rusher for coming on the show, and I'll see you in the future!
</div>
