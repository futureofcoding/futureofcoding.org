---
title: 39 - Theoretical Foundations for Programmer Experience - Cyrus Omar
---

# #39 - Theoretical Foundations for Programmer Experience: Cyrus Omar



_04/17/2019_

<!--* similar to Paul Chuisano and I-->
<!--* structured editor-->
<!--* subsuming google docs and git with edit semantics (CRDT)-->
<!--* programs with typed holes automatically inserted-->
<!--* take all auxiliary tools about programming and add to language semantics-->
<!--* PL & E is base and you build all features on top of and into that-->
<!--* computational wikipedia / collaborative science-->
<!--* gap problem-->
<!--* making structured editors fluid-->
<!--* automatically inserting holes-->
<!--* theoretical foundations for safe hot realoading / incremental computation for changing functions (instead of inputs)-->
<!--* contextual modal type theory, older logic from before comptuers for what's neccesary-->
<!--* pallates for every literal (compositionally and nested)-->
<!--* defense of greek letters, math is compression-->
