...
The denotative community can be viewed as a small subset of the functional programming community. It's mathematical roots scares of many potential supporters, including myself initially. I am working on efforts to democratize the denotative approach, such as this essay and flow visualizations, to help gain this movement supporters. The more people who see the value in this approach, the more effort will be put behind bringing denotative interfaces to modern technologies, and the sooner the denotative approach can be applied to a computational problem near you.
