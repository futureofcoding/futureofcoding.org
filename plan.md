...
- finish cleaning up the conversion of this doc from google docs to markdown
- Re read old version of the /plan, /about and recent /log
  - TODO
- /plan
  - Organize this outline
  - Write it!
- /goals
  - Like at TCS
- /about
...
- /community-guidelines
  - Collab on this via github issues, pull requests, etc

- The goal
  - Javascript / facebook
  - Better articulate this so I know when I&#39;m done
    - What is coding? What is art? What does the word language have to do with anything?
    - Future of &quot;communication&quot;? Augmenting humans? Augmenting thinking?
    - Genii be careful what you wish for. Get all you wish for (glench)
- My strategy
...
* Care less about money more about open source
* Medium is message
      - Git Linux Facebook
  ...
  - Story of finding this strategy
 ...
 * 50k Twitter followers by Jan 1 2019
 * 50k people \* 1 hour over the year = 50k hours on my blogs / videos in 2018
 * Think about metric for projects created from my content
 * Think about metric for end user &quot;benefit&quot; from &quot;stuff&quot; FoC people create
 ...
 * Series of talks / essays
       ...
       * Motivated by green checks, systematic
        - TODO listen to last few minutes of season 2 voice memo
        - Teaching method
       * Socratic
       ...
       * Peak
      - &quot;So you want to make tech more inclusive&quot;
        - Ask Nicole Kelner for help
        - Put keep notes for this in correct place
 * Figure out which conferences to give these talks
      - Key is great recording, right audience, close by, pay for travel
 * Transitioning WoofJS
      - Make post about who we‘re looking for.
 ...
 * Databases
      - Codd at top
 * Block chain
      - Guy who created ethereum at top
 ...
 * Topical solo episodes?
  - Maintain a public list of blog topics
 * Migrate from trello
 ...
 * Virtual events?
  - Sustainability
 * Look into Patreon and alternatives such as open collective
      - Interview Nicky Case
      - Interview Nadia engle
 * Explore &quot;give it back to community model with Zach Valenti&quot;
 * Look into Purpose Ventures
  - Twitter plan
 * Read advice on twitter
 * Find chats and hashtags that are relevant to me and join them
